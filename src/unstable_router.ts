...
import { getBody, getHeaders, getSearchParams } from "./context.js"
import { RouterError, statusText } from "./error.js"
import { executeGlobalMiddlewares, executeMiddlewares } from "./middlewares.js"
import type { EndpointConfig, GetHttpHandlers, HTTPMethod, RouteEndpoint, RoutePattern, RouterConfig } from "./types.js"
...
const getDynamicParams = (params: Record<string, string>, config: EndpointConfig) => {
